...
<body class="bg-gray-100">
    <form action="/login-blog/action" method="POST">
        @csrf
        <div class="p-10 flex flex-col justify-between items-center h-screen">
            ...
            <div class="button w-[30rem] text-center">
                <p class="text-sm mb-1">Belum Punya Akun? <a href="/registrasi-blog"
                        class="underline text-blue-500">Buat</a></p>
                <button type="submit" class="w-full bg-blue-600 rounded-lg text-white px-5 py-3 font-semibold">Login</button>
            </div>
        </div>
    </form>
</body>
