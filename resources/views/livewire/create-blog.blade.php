<div>
    ...
    <div class="flex justify-start items-center flex-col p-10">
        ...
        <div class="content form-control mt-5 flex w-full">
            ...
            <div class="flex flex-col w-full mt-2" wire:ignore>
                <label for="" class="text-sm mb-3">Blog</label>
                <div type="text" wire:model='content' id="editor"
            ...
            <div class="button mt-10 flex justify-between">
                ...
                <button type="button" class="btn btn-sm bg-blue-500 rounded-lg shadow-sm text-white px-5" wire:click="create">
                    <div class="flex flex-row justify-center items-center gap-2">
