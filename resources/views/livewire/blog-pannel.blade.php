        ...
        <div class="flex min-h-screen">
            ...
            <main class="flex-1 ml-64 p-8">
                <div class="flex justify-between items-center mb-8">
                    <h1 class="text-2xl font-semibold">Blog Overview</h1>
                            ...
                            <tr class="border-b">
                                ...
                                <td class="py-2 px-4">
                                    <img alt="Profile picture of George Lindelof" class="rounded-full w-10 h-10"
                                        height="40"
                                        src="{{ asset('storage/'. (trim($item->image_url, '"') ?? 'images/default.jpg')) }}"
                                        width="40" />
                                </td>
                                <td class="py-2 px-4 text-sm text-gray-700">
                                    {{ $item->title }}
                                ...
                                <td class="py-2 px-4 text-start">
                                    <div class="flex w-20 justify-center items-center gap-2">
                                        <button wire:click="delete({{ $item->id_blog }})">
                                            <i class="fas fa-trash-alt text-rose-600">
                                            </i>
                                        </button>
                                        <button wire:click="view({{ $item->id_blog }})">
